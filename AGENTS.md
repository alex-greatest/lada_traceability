...
5. Запрещено добавлять новые SQL-конкатенации с внешними данными; использовать параметризованные запросы или безопасный ORM-путь.
6. Любой новый production-инцидент обязан быть добавлен в `docs/60-error-catalog-and-troubleshooting.md`.
